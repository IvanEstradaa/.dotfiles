...
# sudo ln -s ~/Repositories/dotfiles/wallpaper/DefaultDesktop.jpg /System/Library/CoreServices/DefaultDesktop.jpg
...
# Increment auto-hiding Dock delay (in order to avoid seeing/using it by accident)
